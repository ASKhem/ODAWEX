...
class MemoryGame {
    constructor(imagenes) {
        this.arrayImagenes = imagenes.slice();
    ...
    inicializarJuego() {
        ...
        console.log(this.manejarTabla.bind(this));
    ...
    reiniciarJuego() {
        ...
        for (let i = 1; i <= 12; i++) {
            ...
            imagen.src = "https://gestionpyme.com/wp-content/uploads/2015/09/shutterstock_227788621.jpg";
            imagen.classList.remove('animate__animated', 'animate__flip', 'animate__bounce');
        }

        this.mezclarArray(this.arrayImagenes);
        this.asignaciones = this.arrayImagenes.slice();
